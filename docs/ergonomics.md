...
<iframe src="https://marimo.app/github/utsmok/AIREloom/blob/main/examples/07_ergonomics_showcase.py/wasm?embed=true&mode=read" sandbox="allow-scripts allow-same-origin allow-downloads allow-popups allow-forms" style="width:100%;height:500px;border:none;border-radius:8px;"></iframe>
