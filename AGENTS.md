...
- **Scholix pid prefix**: `sourcePid`/`targetPid` must be the bare pid value (`10.1038/nature12373`); a `doi:`-prefixed value (`doi:10.1038/...`) silently returns 0 links, HTTP 200 (verified 2026-09).
